...
export const DockItem = ({ mouseX, children }: DockItemProps) => {
  ...
  return (
    <motion.div
      ref={ref}
      style={{ width }}
      className="aspect-square w-10 rounded-full bg-secondary border border-border text-muted hover:text-foreground flex items-center justify-center transition-colors"
    >
      <motion.div
